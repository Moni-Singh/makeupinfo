...
object MakeUpApiInstance {
    ...
    private var apiInterface: MakeUpApiInterface? = null
    val makeupApiInterface: MakeUpApiInterface?
        get() {
            if (apiInterface == null) {
                apiInterface =
                    createService(MakeUpApiInterface::class.java)
            }
            return apiInterface
        }
}